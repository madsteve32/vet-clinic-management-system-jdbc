...
public class DoctorServiceImpl implements DoctorService {
    ...
    @Override
    public Appointment updateAppointmentInfo(Appointment appointment) throws NonexistingEntityException {
    ...
    @Override
    public Examination createExamination(Examination examination) throws InvalidEntityDataException {
    ...
    @Override
    public Doctor addDoctor(Doctor doctor) throws InvalidEntityDataException {
    ...
    @Override
    public Doctor updateDoctor(Doctor doctor) throws InvalidEntityDataException, NonexistingEntityException {
        int firstNameLength = doctor.getFirstName().length();
        if (firstNameLength < 2 || firstNameLength > 15) {
            throw new InvalidEntityDataException("First name must be between 2 and 15 characters.");
        }
